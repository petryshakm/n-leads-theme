                ...
                <div class="table-responsive table-leads-wrapper">
                  <table class="table sortable">
                    ...
                    <?php
                      ...
                      $daysAmount = get_field('days_amount');

                      $daysAmountValue = (($daysAmount) ? $daysAmount . 'days ago' : '30 days ago');
                      ...
                      $leads_args = array(
                          ...
                          'meta_query'     => array(
                              array(
                                  'key'     => 'date',
                                  'value'   => array(date('Ymd', strtotime($daysAmountValue)), date('Ymd')),
                                  'compare' => 'BETWEEN',
                                  'type'    => 'DATETIME',
                              ),
                          ),
